...
var NodeBackend = /** @class */ (function (_super) {
    ...
    NodeBackend.prototype.eventFromException = function (exception, hint) {
        return utils_1.resolvedSyncPromise(eventbuilder_1.eventFromError(exception, hint));
    };
    /**
     * @inheritDoc
     */
    NodeBackend.prototype.eventFromMessage = function (message, level, hint) {
        ...
        return utils_1.resolvedSyncPromise(eventbuilder_1.eventFromMessage(this._options, message, level, hint));
    };
    /**
     * @inheritDoc
     */
